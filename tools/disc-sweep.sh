...
for a in "disc-d03-s1234 0.3 1234" "disc-d10-s1234 1.0 1234" \
         "disc-d00-s5678 0.0 5678" "disc-d03-s5678 0.3 5678" "disc-d10-s5678 1.0 5678"; do
  run_arm $a || exit 1
done
echo "=== S1b SWEEP DONE $(date +%H:%M:%S) ==="
